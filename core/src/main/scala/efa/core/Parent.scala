...
/**
  ...
  * There must be a implementation of Traverse defined for the container
  * type.
  *
  * This type classes has its uses in UI programming, especially when
  * displaying nested data structures in tree-like views.
  *
  * @tparam P: The parent type
  * @tparam C: The child param
